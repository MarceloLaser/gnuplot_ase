...
set output "table3b_candlesticks.png"
set title "Table 3B - Percentage of Expires headers"
unset key
...
plot "table3b.dat" using 1:2:3:2:3 with candlesticks lt 3 lw 2 notitle, \

...
set output "table3f_candlesticks.png"
set title "Table 3F - Percentage of Trusty cacheControl headers"
unset key
...
plot "table3f.dat" using 1:2:3:2:3 with candlesticks lt 3 lw 2 notitle, \

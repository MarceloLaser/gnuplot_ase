...
set output "table3e_candlesticks.png"
set title "Table 3E - Percentage of cacheControl headers"
unset key
...
plot "table3e.dat" using 1:2:3:2:3 with candlesticks lt 3 lw 2 notitle, \
